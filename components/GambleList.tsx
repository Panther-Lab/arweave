...
import { projectsGamble } from "@/data";
  ...
  return (
    <div className="py-5">
      <h1 className="text-3xl flex items-center justify-center">
        <span className="">Earn Rewards</span>
      </h1>
