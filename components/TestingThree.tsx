...
export function TestingThree() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      <h1 className="text-3xl font-bold mb-4">YK Tennis</h1>
      
      <div className="mb-6">
        {!gameSessionActive ? (
          <>
            <img src="/yk-tennis.png" alt="YK Tennis" className="w-full h-64 object-cover rounded-lg mb-4" />
            <p className="text-lg mb-4">
              Experience the thrill of tennis in this fast-paced sports game. Compete against AI or challenge your friends in multiplayer mode.
            </p>
