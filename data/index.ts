...
export const faqData: FAQItem[] = [
  ...
  {
    question:
      "What types of transactions can I perform with the platform from the prespective of Web2 user?",
    answer:
...
export const offers = [
  {
    ...
    details: "Accumulate rewards through in-game achievements and progress.",
  },
  {
  ...
  },
  {
    ...
    details: " Explore and play over 5 exciting games, earn rewards.",
  },
];
...
export const projectsGamble: Project[] = [
  {
    id: 1,
    title: "Game 1: Mines",
    des: "Navigate a grid filled with hidden mines, using logic to uncover safe squares while avoiding detonation. The game combines strategy and risk, offering thrilling gameplay where every click could lead to victory or loss.",
    img: "/mines.png",
    iconLists: ["/next.svg", "/tail.svg", "/ts.svg", "/three.svg", "/gsap.svg"],
    link: "/mines",
    imageLink: "/mines.png",
  },
  {
    id: 2,
    title: "Game 2: Crash",
    des: "Experience high-stakes excitement as players bet on a rising multiplier that can crash at any moment. The objective is to cash out before the multiplier stops, blending adrenaline and strategy in a race against time.",
    img: "/crash.png",
    iconLists: ["/next.svg", "/tail.svg", "/ts.svg", "/three.svg", "/gsap.svg"],
    link: "/crash",
    imageLink: "/crash.png",
